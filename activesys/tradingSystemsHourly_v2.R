...
getLatestPrices = function(){
    ...
    USDCAD = prepareForexOandaPrices(oanda.count = 2, Cur1 = "USD", Cur2 = "CAD", oanda.granularity = 'H1')
...
AUDUSD = prepareForexOandaPrices(oanda.count = 1000, Cur1 = "AUD", Cur2 = "USD", oanda.granularity = 'H1')
USDCAD = prepareForexOandaPrices(oanda.count = 1000, Cur1 = "USD", Cur2 = "CAD", oanda.granularity = 'H1')
...
while(TRUE){
    tryCatch({
        ...
        if(latestPrices$update.date > lastDate){
            ...
            png(paste0("~/Common/audcad_intraday_h1//plots/audcad_intraday_h1_",format(index(tail(tmp.prices,1)), "%Y%m%d%H%M"),".png"))
            par(mfcol = c(3,1))
            ...
            updateDirFilePermissions('~/Common/audcad_intraday_h1/')
        }
    },
